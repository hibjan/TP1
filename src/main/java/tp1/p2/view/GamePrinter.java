...
public class GamePrinter {
	...
	protected String getInfo() {
		...
		buffer.append(Messages.NUMBER_OF_CYCLES + SPACE + game.getCycles());
		buffer.append(NEW_LINE);
		buffer.append(Messages.NUMBER_OF_COINS + SPACE + game.getSuncoins());
		buffer.append(NEW_LINE);
		buffer.append(Messages.REMAINING_ZOMBIES + SPACE + game.getRemainingZombies());
		buffer.append(NEW_LINE);
		buffer.append(Messages.GENERATED_SUNS + SPACE + game.getGeneratedSuns());
		buffer.append(NEW_LINE);
		buffer.append(Messages.CAUGHT_SUNS + SPACE + game.getCaughtSuns());
		buffer.append(NEW_LINE);
		buffer.append(Messages.SCORE + SPACE + game.getScore());
		buffer.append(NEW_LINE);
